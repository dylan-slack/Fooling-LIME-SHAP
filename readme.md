...
We provide a short walk through on COMPAS in `COMPAS_Example.ipynb`.  This is a nice place to get started to see how our method works.  The full experiments from the paper can be found in `compas_experiment.py`.  The experiments for Communities and Crime and German will be added soon! 

<!-- `cc_experiment.py`and `german_experiment.py`.   -->
